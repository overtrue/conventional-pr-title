...
export declare class GitHubService {
     ...
     * Create comment
     */
    createComment(prNumber: number, body: string): Promise<{
        id: number;
        node_id: string;
        url: string;
        body?: string;
     ...
     * Extract PR context
     */
    extractPRContext(prNumber: number, pullRequest: any): Promise<PRContext>;
    private extractDiffContent;
}
/**
 * Create GitHub service instance
 */
export declare function createGitHubService(token?: string): GitHubService;
