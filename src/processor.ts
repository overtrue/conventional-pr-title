...
Generate improved Conventional Commits titles for this PR.`
  ...
  private formatSuggestionComment(currentTitle: string, suggestions: string[], reasoning: string): string {
    ...
    const lines = [
      ...
      '',
      `---`,
      `*This suggestion was generated by AI to help maintain consistent commit message standards using [conventional-pr-title](https://github.com/overtrue/conventional-pr-title) action.*`
    ]
  ...
  private formatSuccessComment(originalTitle: string, newTitle: string, reasoning?: string): string {
    ...
    lines.push(
      `---`,
      `*This update was performed automatically by AI to maintain consistent commit message standards using [conventional-pr-title](https://github.com/overtrue/conventional-pr-title) action.*`
    )
